...
public interface EmployeeRepository  extends JpaRepository<Employee, Long> {
    ...
    @Query(value = "select * from employess e where e.emp_firstname=?1 and e.emp_lastname=?2", nativeQuery = true)
    ...
    @Query(value = "select * from employess e where e.emp_firstname=:firstName and e.emp_lastname=:lastName", nativeQuery = true)
